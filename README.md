...
- Add a type from each Unused section (hive boxes / frames / tops and bottoms / other): name, owned count, optional photo. Delete any type, including the starter set.
