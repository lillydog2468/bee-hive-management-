  ...
  return (
    ...
    >
      ...
      <section className="card">
        ...
        <p className="card-copy">
          Replace everything in this browser with the starting point: 20 unused deep boxes, 20 unused shallow boxes, 5 spare metal lids (7 more on the L-yard full-size hives), three frame lots of 50, bottoms and inner covers on every hive (spare counts not given), the three sites, and stacks only where they were given.
        </p>
        {confirm ? (
